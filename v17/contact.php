...
if (!isset($_POST['submit'])) 
{
	...
	//if (isset($_GET['dataSaved']) && $_GET['dataSaved'] == '1')
	...
	{
		# connect to database
		$mysql_username = "[redacted]"; // username redacted from GitHub for privacy
		$mysql_password = "[redacted]"; // password redacted from GitHub for privacy
		$host = "localhost";
		$db = "contact_data";
		$dblink = new mysqli($host, $mysql_username, $mysql_password, $db);
		...
		//header("Location: index.php?page=contact&dataSaved=1");
		echo '<div id="about" class="about-main pad-top-100 pad-bottom-100">';
